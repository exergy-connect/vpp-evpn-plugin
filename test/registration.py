...
cli('set interface ip address bvi10001 169.254.0.1/32')
...
cli('create loopback interface instance 90')
cli('set interface ip address loop90 10.0.0.1/24')
cli('set interface state loop90 up')
